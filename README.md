...
<!-- CATALOG:START -->
**230 skills** across 11 categories — browse via `skillshare search --hub` or the Web UI
...
<details>
<summary>Show 104 skills</summary>
...
- [**azure-reliability**](https://github.com/microsoft/azure-skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Azure Reliability management and best practices
...
- [**edit-article**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Edit Article skill for AI agent workflows
...
- [**paperclip**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Paperclip skill for AI agent workflows
- [**paperclip-board**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Paperclip Board skill for AI agent workflows
- [**paperclip-converting-plans-to-tasks**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Paperclip Converting Plans To Tasks skill for AI agent workflows
- [**para-memory-files**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Para Memory Files skill for AI agent workflows
...
- [**qa**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Qa skill for AI agent workflows
...
- [**request-refactor-plan**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Request Refactor Plan skill for AI agent workflows
...
- [**supabase**](https://github.com/supabase/agent-skills) ![risk-critical](https://img.shields.io/badge/risk-critical-red) — Supabase skill for AI agent workflows
...
- [**ubiquitous-language**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Ubiquitous Language skill for AI agent workflows
...
- [**writing-great-skills**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Writing Great Skills skill for AI agent workflows
...
- [**paperclip-create-agent**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Paperclip Create Agent skill for AI agent workflows
...
- [**design-an-interface**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Design An Interface skill for AI agent workflows
- [**design-guide**](https://github.com/getpaperclipai/paperclip) ![risk-high](https://img.shields.io/badge/risk-high-orange) — Design Guide skill for AI agent workflows
- [**emil-design-eng**](https://github.com/emilkowalski/skills) ![risk-low](https://img.shields.io/badge/risk-low-green) — Emil Design Eng skill for AI agent workflows
...
- [**obsidian-vault**](https://github.com/mattpocock/skills) ![risk-clean](https://img.shields.io/badge/risk-clean-brightgreen) — Obsidian Vault skill for AI agent workflows
