...
- [**baoyu-post-to-x**](https://github.com/jimliu/baoyu-skills) ![risk-medium](https://img.shields.io/badge/risk-medium-yellow) — Compose and publish posts to X/Twitter with media support
...
- [**azure-compliance**](https://github.com/microsoft/github-copilot-for-azure) ![risk-medium](https://img.shields.io/badge/risk-medium-yellow) — Azure compliance assessment and policy management
...
- [**azure-deploy**](https://github.com/microsoft/github-copilot-for-azure) ![risk-low](https://img.shields.io/badge/risk-low-green) — Azure deployment automation and resource provisioning
...
- [**azure-postgres**](https://github.com/microsoft/github-copilot-for-azure) ![risk-medium](https://img.shields.io/badge/risk-medium-yellow) — Azure Database for PostgreSQL management and optimization
...
- [**azure-storage**](https://github.com/microsoft/github-copilot-for-azure) ![risk-low](https://img.shields.io/badge/risk-low-green) — Azure Storage services configuration and best practices
...
- [**entra-app-registration**](https://github.com/microsoft/github-copilot-for-azure) ![risk-medium](https://img.shields.io/badge/risk-medium-yellow) — Microsoft Entra ID app registration and authentication setup
